    ...
    <div className="page-container">
      <div className="page-content">
        <header className="page-header">
          <h1 className="page-title">How Generative AI Works: Core Concepts</h1>
        ...
        <section className="content-section">
          ...
          <div className="content-card border-blue-200">
        ...
        {/* Limitations Section */}
        <section className="content-section border-red-200">
          <h2 className="section-title">Understanding AI Limitations</h2>
